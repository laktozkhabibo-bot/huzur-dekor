/* ═══════════════════════════════════════════
   Huzur Dekor — i18n (AR / TR) + interactions
   ═══════════════════════════════════════════ */
...
const PAGE_TITLES = {
  ar: "Huzur Dekor — ننقل الجودة إلى منزلكم",
  tr: "Huzur Dekor — Kaliteyi Evinize Taşıyoruz",
};
...
langSwitch.addEventListener("click", () => {
  const next = document.documentElement.lang === "ar" ? "tr" : "ar";
  applyLang(next);
});

applyLang(localStorage.getItem("huzur-lang") || "ar", false);
